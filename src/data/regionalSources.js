...
export const REGIONAL_SOURCES = Object.freeze({
  ...
  'vic-road-unplanned': Object.freeze({
    name: 'Victorian Unplanned Road Disruptions', source: 'Transport Victoria Open Data Portal',
    publisher: 'Department of Transport and Planning Victoria',
    endpoint: 'https://api.opendata.transport.vic.gov.au/api/opendata/roads/disruptions/unplanned/v3',
    licence: 'Creative Commons Attribution 4.0 International', geometry: 'point-or-line', refreshMs: 60_000,
    maxStaleMs: 300_000,
    refresh: 'provider-wide one-minute cache; road disruption context only, not a substitute for signs, traffic controls or emergency advice',
    credit: 'Source: Department of Transport and Planning Victoria, licensed under Creative Commons Attribution 4.0 International.',
    credential: 'none', serverCredential: 'TRANSPORT_VIC_OPEN_DATA_API_KEY', credentialEnv: 'TRANSPORT_VIC_OPEN_DATA_API_KEY',
    configuredEnv: 'VITE_TRANSPORT_VIC_OPEN_DATA_CONFIGURED', credentialsReason: 'Transport Victoria Open Data Portal key required',
    runtimeEligible: true, maxFeatures: 500,
  }),
  'vic-lane-signals': Object.freeze({
    name: 'Victorian Lane-use Signals', source: 'Transport Victoria Open Data Portal',
    publisher: 'Department of Transport and Planning Victoria',
    endpoint: 'https://api.opendata.transport.vic.gov.au/opendata/roads/lums/v1/sites',
    licence: 'Creative Commons Attribution 4.0 International', geometry: 'point', refreshMs: 30_000,
    maxStaleMs: 120_000,
    refresh: 'provider-wide thirty-second cache; display context only—obey the signs and conditions physically shown at the site',
    credit: 'Source: Department of Transport and Planning Victoria, licensed under Creative Commons Attribution 4.0 International.',
    credential: 'none', serverCredential: 'TRANSPORT_VIC_OPEN_DATA_API_KEY', credentialEnv: 'TRANSPORT_VIC_OPEN_DATA_API_KEY',
    configuredEnv: 'VITE_TRANSPORT_VIC_OPEN_DATA_CONFIGURED', credentialsReason: 'Transport Victoria Open Data Portal key required',
    runtimeEligible: true, maxFeatures: 1_000,
