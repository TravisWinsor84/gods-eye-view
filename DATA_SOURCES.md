...
| `vic-road-unplanned` | Department of Transport and Planning Victoria, [Unplanned Disruptions API v3](https://opendata.transport.vic.gov.au/) | Creative Commons Attribution 4.0 International; the existing Transport Victoria portal key is required server-side | `Source: Department of Transport and Planning Victoria, licensed under Creative Commons Attribution 4.0 International.` | Point or line | Provider-wide one-minute cache with five-minute bounded last-good; contextual incident data only, not a substitute for signs, traffic controls, or emergency advice |
| `vic-lane-signals` | Department of Transport and Planning Victoria, [Lane Use Management System API](https://opendata.transport.vic.gov.au/) | Creative Commons Attribution 4.0 International; the existing Transport Victoria portal key is required server-side | `Source: Department of Transport and Planning Victoria, licensed under Creative Commons Attribution 4.0 International.` | Point | Provider-wide 30-second cache with two-minute bounded last-good; display context only and never driving instruction—obey the physical signs and conditions at the site |
| `vic-wetlands-2025` | DEECA, [Victorian Wetland Inventory (Current)](https://discover.data.vic.gov.au/dataset/victorian-wetland-inventory-current), pinned 2025 SHP release | [Creative Commons Attribution 4.0 International](https://creativecommons.org/licenses/by/4.0/) | `Copyright © The State of Victoria, Department of Energy, Environment and Climate Action. Licensed under Creative Commons Attribution 4.0 International.` | Polygon | Implemented deterministic preprocessing, integrity-checked local release serving, bounded viewport queries, and conditional Environment-pack registration. Remains unavailable until the free whole-state DataShare order is delivered, hash-recorded, processed, and configured. Mapped-inventory reference only—not live water/flood extent, access advice, or proof that water is present. |
| `au-dea-land-cover` | Geoscience Australia, [DEA Land Cover](https://knowledge.dea.ga.gov.au/data/product/dea-land-cover-landsat/) through the official DEA WMS | [Creative Commons Attribution 4.0 International](https://creativecommons.org/licenses/by/4.0/) | `Digital Earth Australia / Geoscience Australia (CC BY 4.0)` | Raster | Implemented off-by-default annual 2020 classification overlay through a fixed same-origin PNG proxy, levels 6–14, five-minute tile cache, bounded dimensions and response bytes. Historical classification only—not current ground conditions or emergency advice. |
